...
public class CommentService {
    ...
    public Comment getByID(Long id) throws ResourceNotFoundException {
        CommentEntity comment = commentDAO.findById(id).orElseThrow(()
                -> new ResourceNotFoundException(ErrorMessage.KEY_COMMENT_NOT_FOUND, ErrorMessage.COMMENT_NOT_FOUND));
